...
def run_demo() -> List[str]:
    ...
    # The real coordinator must hard-stop MotionOutput and claim("external")
    # at this boundary. The example has no chassis, so it records the handoff.
    follower.pause(1.10)
    trace.append("owner:external")
    task = DemoTask()
